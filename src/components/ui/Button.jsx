...
const Button = ({ text, svg, url }) => {
	return [
		<a href={url} className="group rounded hover:drop-shadow-lg bg-white text-black border-black border cursor-pointer flex justify-between items-center overflow-hidden">
